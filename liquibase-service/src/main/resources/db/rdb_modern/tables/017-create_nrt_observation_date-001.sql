...
IF
EXISTS (SELECT 1 FROM sysobjects WHERE name = 'nrt_observation_date' and xtype = 'U')
BEGIN
    IF
NOT EXISTS(SELECT 1 FROM sys.columns WHERE name = N'ovd_seq' AND Object_ID = Object_ID(N'nrt_observation_date'))
BEGIN
