CREATE OR ALTER PROCEDURE [dbo].[sp_d_morbidity_report_postprocessing] @id_list nvarchar(max), @debug bit = 'false'
...
BEGIN
    ...
    BEGIN TRY
        ...
        --CREATE TABLE SAS_up_MORBIDITY_RPT_EVNT_lst AS
        ...
        */
        ...
        from #s_updated_lab as updated_lab
        ...
        */
        ...
        IF OBJECT_ID('#tmp_MorbFrmQCoded2', 'U') IS NOT NULL
        ...
        FROM
            (
                SELECT [CD]
                FROM [dbo].#tmp_MorbFrmQCoded AS p
                GROUP BY [CD]
            ) AS x;
        SET @sql = N'
        ...
        */
        ...
        IF OBJECT_ID('#tmp_MorbFrmQDate2', 'U') IS NOT NULL
        ...
        FROM
            (
                SELECT [CD]
                FROM [dbo].#tmp_MorbFrmQDate AS p
                GROUP BY [CD]
            ) AS x;
        ...
        */
        ...
        IF OBJECT_ID('#tmp_MorbFrmQTxt2', 'U') IS NOT NULL
        ...
        IF OBJECT_ID('tmp_MorbFrmQCoded2', 'U') IS  NULL
        ...
        IF OBJECT_ID('#tmp_MorbFrmQDate2', 'U') IS  NULL
        ...
        IF OBJECT_ID('#tmp_MorbFrmQTxt2', 'U') IS  NULL
        ...
        */
        ...
        IF(COL_LENGTH('#TMP_Morbidity_Report', 'INV128') IS  NOT NULL)
            BEGIN
                UPDATE #TMP_Morbidity_Report set	 HOSPITALIZED_IND	=	INV128 	;
            END
            ;
        ...
        IF(COL_LENGTH('#TMP_Morbidity_Report', 'INV145') IS  NOT NULL)
            BEGIN
                UPDATE #TMP_Morbidity_Report set	 DIE_FROM_ILLNESS_IND	=	INV145 	;
            END
            ;
        ...
        IF(COL_LENGTH('#TMP_Morbidity_Report', 'INV148') IS  NOT NULL)
            BEGIN
                UPDATE #TMP_Morbidity_Report set	 DAYCARE_IND	=	INV148 	;
            END
            ;
        ...
        IF(COL_LENGTH('#TMP_Morbidity_Report', 'INV149') IS  NOT NULL)
            BEGIN
                UPDATE #TMP_Morbidity_Report set	 FOOD_HANDLER_IND	=	INV149 	;
            END
            ;
        ...
        IF(COL_LENGTH('#TMP_Morbidity_Report', 'INV178') IS  NOT NULL)
            BEGIN
                UPDATE #TMP_Morbidity_Report set	 PREGNANT_IND	=	INV178 	;
            END
            ;
        ...
        IF(COL_LENGTH('#TMP_Morbidity_Report', 'MRB100') IS  NOT NULL)
            BEGIN
                UPDATE #TMP_Morbidity_Report set	 MORB_RPT_TYPE	=	MRB100 	;
            END
            ;
        ...
        IF(COL_LENGTH('#TMP_Morbidity_Report', 'MRB102') IS  NOT NULL)
            BEGIN
                UPDATE #TMP_Morbidity_Report set	 MORB_RPT_COMMENTS	=	rtrim(MRB102) 	;
            END
            ;
        ...
        IF(COL_LENGTH('#TMP_Morbidity_Report', 'MRB122') IS  NOT NULL)
            BEGIN
                UPDATE #TMP_Morbidity_Report set	 TEMP_ILLNESS_ONSET_DT_KEY	=	MRB122 	;
            END
            ;
        ...
        IF(COL_LENGTH('#TMP_Morbidity_Report', 'MRB129') IS  NOT NULL)
            BEGIN
                UPDATE #TMP_Morbidity_Report set	 NURSING_HOME_ASSOCIATE_IND	=	substring(MRB129,1,1)  	;
            END
            ;
        ...
        IF(COL_LENGTH('#TMP_Morbidity_Report', 'MRB130') IS  NOT NULL)
            BEGIN
                UPDATE #TMP_Morbidity_Report set	 HEALTHCARE_ORG_ASSOCIATE_IND	=	MRB130 	;
            END
            ;
        ...
        IF(COL_LENGTH('#TMP_Morbidity_Report', 'MRB161') IS  NOT NULL)
            BEGIN
                UPDATE #TMP_Morbidity_Report set	 MORB_RPT_DELIVERY_METHOD	=	MRB161 	;
            END
            ;
        ...
        IF(COL_LENGTH('#TMP_Morbidity_Report', 'MRB165') IS  NOT NULL)
            BEGIN
                UPDATE #TMP_Morbidity_Report set	 TEMP_DIAGNOSIS_DT_KEY	=	MRB165 	;
            END
            ;
        ...
        IF(COL_LENGTH('#TMP_Morbidity_Report', 'MRB166') IS  NOT NULL)
            BEGIN
                UPDATE #TMP_Morbidity_Report set	 HSPTL_ADMISSION_DT	=	MRB166 	;
            END
            ;
        ...
        IF(COL_LENGTH('#TMP_Morbidity_Report', 'MRB167') IS  NOT NULL)
            BEGIN
                UPDATE #TMP_Morbidity_Report set	 TEMP_HSPTL_DISCHARGE_DT_KEY	=	MRB167 	;
            END
            ;
        ...
        IF(COL_LENGTH('#TMP_Morbidity_Report', 'MRB168') IS  NOT NULL)
            BEGIN
                UPDATE #TMP_Morbidity_Report set	 SUSPECT_FOOD_WTRBORNE_ILLNESS	=	MRB168 	;
            END
            ;
        ...
        IF(COL_LENGTH('#TMP_Morbidity_Report', 'MRB169') IS  NOT NULL)
            BEGIN
                UPDATE #TMP_Morbidity_Report set	 MORB_RPT_OTHER_SPECIFY	=	MRB169 	;
            END
            ;
        ...
        */
        ...
        IF OBJECT_ID('dbo.tmp_SAS_Morbidity_Report', 'U') IS NOT NULL
...
*/
        ...
        IF OBJECT_ID('dbo.SAS_morb_Rpt_User_Comment', 'U') IS NOT NULL
            drop table SAS_morb_Rpt_User_Comment;
        ...
        */
        ...
        from #TMP_Morbidity_Report	rpt
            ...
            and par.record_status_cd = 'ACTIVE'
                 left join d_patient pat on par.subject_entity_uid = pat.patient_uid
                 left join condition	con on  rpt.condition_cd =con.condition_cd	AND rtrim(con.condition_cd) != ''
            /*HEALTH_CARE_KEY   */
                 left join nbs_odse..participation par1 on rpt.morb_rpt_uid = par1.act_uid and par1.type_cd = 'HCFAC'
                 left join d_Organization org1 on org1.Organization_uid = par1.subject_entity_uid
            /*HSPTL_DISCHARGE_DT_KE*/
                 left join rdb_date	dt3	on rpt.TEMP_HSPTL_DISCHARGE_DT_KEY = dt3.DATE_MM_DD_YYYY
            /*	HSPTL_KEY*/
            ...
            AND par2.subject_class_cd = 'ORG'
                 left join d_Organization org2 on par2.subject_entity_uid = org2.Organization_uid

            /*ILLNESS_ONSET_DT_KEY*/
                 left join rdb_date	dt4	on rpt.TEMP_ILLNESS_ONSET_DT_KEY = dt4.DATE_MM_DD_YYYY
            ...
            and ar1.record_status_cd = 'ACTIVE'
                 left join Investigation inv on ar1.target_act_uid = inv.case_uid
            /*MORB_RPT_CREATE_DT_KEY*/
                 left join rdb_date	dt5	on CAST(CONVERT(VARCHAR,rpt.morb_RPT_Created_DT,102) AS DATETIME)  = dt5.DATE_MM_DD_YYYY
            /*MORB_RPT_DT_KEY*/
                 left join rdb_date	dt6	on rpt.morb_report_date = dt6.DATE_MM_DD_YYYY
            ...
            and par3.subject_class_cd ='ORG'
                 left join d_Organization org3	on par3.subject_entity_uid = org3.Organization_uid
            /*PHYSICIAN_KEY*/
            ...
            and par4.record_status_cd = 'ACTIVE'
                 left join d_provider phy	on par4.subject_entity_uid = phy.provider_uid
            /*	REPORTER_KEY           */
            ...
            and par6.record_status_cd = 'ACTIVE'
                 left join d_provider per1	on par6.subject_entity_uid = per1.provider_uid
            /*Ldf group key*/
