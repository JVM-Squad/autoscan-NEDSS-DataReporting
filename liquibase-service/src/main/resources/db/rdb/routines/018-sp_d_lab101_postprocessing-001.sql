 ...
 BEGIN TRY
	...
	SET @Proc_Step_Name = 'SP_Start';
		   ...
		   BEGIN TRANSACTION;
			...
			SET @PROC_STEP_NAME = ' DELETING UPDATED KEYS FROM LAB101';


			-- can be replaced by just deleting on condition: where RESULTED_LAB_TEST_KEY IN split(ids)
			delete 
			from rdb_modern..lab101
			where RESULTED_LAB_TEST_KEY in (SELECT value FROM STRING_SPLIT(@lab_test_keys, ','))
			;
...
--CREATE TABLE ISOLATE_TRACKING_INIT AS
		   ...
		   BEGIN
			   ...
			   BEGIN TRANSACTION;
					...
					SELECT  lt.LAB_TEST_KEY, lrv.TEST_RESULT_GRP_KEY, lt.LAB_TEST_CD, lrv.TEST_RESULT_VAL_CD, 
										  lrv.TEST_RESULT_VAL_CD_DESC, lrv.FROM_TIME, 
					...
					WHERE
						lt.LAB_TEST_KEY IN (SELECT value FROM STRING_SPLIT(@lab_test_keys, ','))
			   ...
			   BEGIN TRANSACTION;
					...
					into #tmp_ISOLATE_TRACKING_INIT
						FROM     rdb_modern..LAB_RESULT_VAL,
								 rdb_modern..TEST_RESULT_GROUPING,
								 rdb_modern..LAB_TEST,
								 rdb_modern..LAB_TEST_RESULT    
					WHERE      
		   ...
		   BEGIN
			...
			SET @PROC_STEP_NAME = ' GENERATING #tmp_RESULTED_TEST_DETAIL1'; 
				...
				WHERE LAB_TEST_I_RESULT.LAB_TEST_TYPE = 'I_Result'
					...
					and resulted_test.LAB_TEST_KEY IN (SELECT value FROM STRING_SPLIT(@lab_test_keys, ','))
...
--CREATE TABLE ISOLATE_TRACKING_LAB330_INIT AS
	   ...
	   if @Table_RowCount_no > 0 
		   BEGIN
			...
			drop table #tmp_ISOLATE_TRACKING_LAB330_INIT ;
					...
					and lt.LAB_TEST_KEY IN (SELECT value FROM STRING_SPLIT(@lab_test_keys, ','))
	   ...
	   if @Table_RowCount_no = 0 
		...
		drop table #tmp_RESULTED_TEST_DETAILS_final ;
					...
					insert into  #tmp_RESULTED_TEST_DETAILS_final (lab_rpt_local_id,PARENT_TEST_PNTR,[RESULTED_LAB_TEST_KEY],record_status_cd,oid,        
					...
					update #tmp_RESULTED_TEST_DETAILS_FINAL set   LAB1  = (  select top 1    substring(trtd.TEST_RESULT_VAL_CD_DESC,1,50)   from #tmp_RESULTED_TEST_DETAILS trtd where #tmp_RESULTED_TEST_DETAILS_FINAL.lab_rpt_local_id  = trtd.lab_rpt_local_id    and   LAB_TEST_CD  =  'LAB329a'   and    TEST_RESULT_VAL_CD_DESC  is not null  and  #tmp_RESULTED_TEST_DETAILS_FINAL.RESULTED_LAB_TEST_KEY =  trtd.RESULTED_LAB_TEST_KEY ) ;
					update #tmp_RESULTED_TEST_DETAILS_FINAL set   LAB2  = (  select top 1    substring(trtd.TEST_RESULT_VAL_CD_DESC,1,50)   from #tmp_RESULTED_TEST_DETAILS trtd where #tmp_RESULTED_TEST_DETAILS_FINAL.lab_rpt_local_id  = trtd.lab_rpt_local_id    and   LAB_TEST_CD  =  'LAB330'   and    TEST_RESULT_VAL_CD_DESC  is not null  and  #tmp_RESULTED_TEST_DETAILS_FINAL.RESULTED_LAB_TEST_KEY =  trtd.RESULTED_LAB_TEST_KEY ) ;
					update #tmp_RESULTED_TEST_DETAILS_FINAL set   LAB3  = (  select top 1   substring(trtd.TEST_RESULT_VAL_CD_DESC,1,50)    from #tmp_RESULTED_TEST_DETAILS trtd where #tmp_RESULTED_TEST_DETAILS_FINAL.lab_rpt_local_id  = trtd.lab_rpt_local_id    and   LAB_TEST_CD  =  'LAB331'   and    TEST_RESULT_VAL_CD_DESC  is not null  and  #tmp_RESULTED_TEST_DETAILS_FINAL.RESULTED_LAB_TEST_KEY =  trtd.RESULTED_LAB_TEST_KEY ) ;
					update #tmp_RESULTED_TEST_DETAILS_FINAL set   LAB4  = (  select top 1    substring(trtd.TEST_RESULT_VAL_CD_DESC,1,50)   from #tmp_RESULTED_TEST_DETAILS trtd where #tmp_RESULTED_TEST_DETAILS_FINAL.lab_rpt_local_id  = trtd.lab_rpt_local_id    and   LAB_TEST_CD  =  'LAB332'   and    TEST_RESULT_VAL_CD_DESC  is not null  and  #tmp_RESULTED_TEST_DETAILS_FINAL.RESULTED_LAB_TEST_KEY =  trtd.RESULTED_LAB_TEST_KEY ) ;
					update #tmp_RESULTED_TEST_DETAILS_FINAL set   LAB5  = (  select top 1    substring(trtd.LAB_RESULT_TXT_VAL,1,100)  from #tmp_RESULTED_TEST_DETAILS trtd where #tmp_RESULTED_TEST_DETAILS_FINAL.lab_rpt_local_id  = trtd.lab_rpt_local_id    and   LAB_TEST_CD  =  'LAB333'   and   LAB_RESULT_TXT_VAL  is not null   and  #tmp_RESULTED_TEST_DETAILS_FINAL.RESULTED_LAB_TEST_KEY =  trtd.RESULTED_LAB_TEST_KEY  ) ;
					update #tmp_RESULTED_TEST_DETAILS_FINAL set   LAB6  = (  select top 1    trtd.FROM_TIME  from #tmp_RESULTED_TEST_DETAILS trtd where #tmp_RESULTED_TEST_DETAILS_FINAL.lab_rpt_local_id  = trtd.lab_rpt_local_id    and   LAB_TEST_CD  =  'LAB334'  and   FROM_TIME  is not null  and  #tmp_RESULTED_TEST_DETAILS_FINAL.RESULTED_LAB_TEST_KEY =  trtd.RESULTED_LAB_TEST_KEY   ) ;
					update #tmp_RESULTED_TEST_DETAILS_FINAL set   LAB7  = (  select top 1    trtd.LAB_RESULT_TXT_VAL  from #tmp_RESULTED_TEST_DETAILS trtd where #tmp_RESULTED_TEST_DETAILS_FINAL.lab_rpt_local_id  = trtd.lab_rpt_local_id    and   LAB_TEST_CD  =  'LAB335'   and   LAB_RESULT_TXT_VAL  is not null   and  #tmp_RESULTED_TEST_DETAILS_FINAL.RESULTED_LAB_TEST_KEY =  trtd.RESULTED_LAB_TEST_KEY  ) ;
					update #tmp_RESULTED_TEST_DETAILS_FINAL set   LAB8  = (  select top 1    substring(trtd.TEST_RESULT_VAL_CD_DESC,1,50)   from #tmp_RESULTED_TEST_DETAILS trtd where #tmp_RESULTED_TEST_DETAILS_FINAL.lab_rpt_local_id  = trtd.lab_rpt_local_id    and   LAB_TEST_CD  =  'LAB336'   and    TEST_RESULT_VAL_CD_DESC  is not null  and  #tmp_RESULTED_TEST_DETAILS_FINAL.RESULTED_LAB_TEST_KEY =  trtd.RESULTED_LAB_TEST_KEY ) ;
					update #tmp_RESULTED_TEST_DETAILS_FINAL set   LAB9  = (  select top 1    substring(trtd.TEST_RESULT_VAL_CD_DESC,1,50)   from #tmp_RESULTED_TEST_DETAILS trtd where #tmp_RESULTED_TEST_DETAILS_FINAL.lab_rpt_local_id  = trtd.lab_rpt_local_id    and   LAB_TEST_CD  =  'LAB337'   and    TEST_RESULT_VAL_CD_DESC  is not null  and  #tmp_RESULTED_TEST_DETAILS_FINAL.RESULTED_LAB_TEST_KEY =  trtd.RESULTED_LAB_TEST_KEY ) ;
					update #tmp_RESULTED_TEST_DETAILS_FINAL set   LAB10  = (  select top 1    substring(trtd.TEST_RESULT_VAL_CD_DESC,1,50)   from #tmp_RESULTED_TEST_DETAILS trtd where #tmp_RESULTED_TEST_DETAILS_FINAL.lab_rpt_local_id  = trtd.lab_rpt_local_id    and   LAB_TEST_CD  =  'LAB338'   and    TEST_RESULT_VAL_CD_DESC  is not null  and  #tmp_RESULTED_TEST_DETAILS_FINAL.RESULTED_LAB_TEST_KEY =  trtd.RESULTED_LAB_TEST_KEY ) ;
					update #tmp_RESULTED_TEST_DETAILS_FINAL set   LAB11  = (  select top 1    substring(trtd.LAB_RESULT_TXT_VAL,1,100)  from #tmp_RESULTED_TEST_DETAILS trtd where #tmp_RESULTED_TEST_DETAILS_FINAL.lab_rpt_local_id  = trtd.lab_rpt_local_id    and   LAB_TEST_CD  =  'LAB339'   and   LAB_RESULT_TXT_VAL  is not null   and  #tmp_RESULTED_TEST_DETAILS_FINAL.RESULTED_LAB_TEST_KEY =  trtd.RESULTED_LAB_TEST_KEY  ) ;
					update #tmp_RESULTED_TEST_DETAILS_FINAL set   LAB12  = (  select top 1    trtd.LAB_RESULT_TXT_VAL  from #tmp_RESULTED_TEST_DETAILS trtd where #tmp_RESULTED_TEST_DETAILS_FINAL.lab_rpt_local_id  = trtd.lab_rpt_local_id    and   LAB_TEST_CD  =  'LAB340'   and   LAB_RESULT_TXT_VAL  is not null   and  #tmp_RESULTED_TEST_DETAILS_FINAL.RESULTED_LAB_TEST_KEY =  trtd.RESULTED_LAB_TEST_KEY  ) ;
					update #tmp_RESULTED_TEST_DETAILS_FINAL set   LAB13  = (  select top 1    trtd.LAB_RESULT_TXT_VAL  from #tmp_RESULTED_TEST_DETAILS trtd where #tmp_RESULTED_TEST_DETAILS_FINAL.lab_rpt_local_id  = trtd.lab_rpt_local_id    and   LAB_TEST_CD  =  'LAB341'   and   LAB_RESULT_TXT_VAL  is not null   and  #tmp_RESULTED_TEST_DETAILS_FINAL.RESULTED_LAB_TEST_KEY =  trtd.RESULTED_LAB_TEST_KEY  ) ;
					update #tmp_RESULTED_TEST_DETAILS_FINAL set   LAB14  = (  select top 1    trtd.LAB_RESULT_TXT_VAL  from #tmp_RESULTED_TEST_DETAILS trtd where #tmp_RESULTED_TEST_DETAILS_FINAL.lab_rpt_local_id  = trtd.lab_rpt_local_id    and   LAB_TEST_CD  =  'LAB342'   and   LAB_RESULT_TXT_VAL  is not null   and  #tmp_RESULTED_TEST_DETAILS_FINAL.RESULTED_LAB_TEST_KEY =  trtd.RESULTED_LAB_TEST_KEY  ) ;
					update #tmp_RESULTED_TEST_DETAILS_FINAL set   LAB15  = (  select top 1    trtd.LAB_RESULT_TXT_VAL  from #tmp_RESULTED_TEST_DETAILS trtd where #tmp_RESULTED_TEST_DETAILS_FINAL.lab_rpt_local_id  = trtd.lab_rpt_local_id    and   LAB_TEST_CD  =  'LAB343'   and   LAB_RESULT_TXT_VAL  is not null   and  #tmp_RESULTED_TEST_DETAILS_FINAL.RESULTED_LAB_TEST_KEY =  trtd.RESULTED_LAB_TEST_KEY  ) ;
					update #tmp_RESULTED_TEST_DETAILS_FINAL set   LAB16  = (  select top 1    trtd.LAB_RESULT_TXT_VAL  from #tmp_RESULTED_TEST_DETAILS trtd where #tmp_RESULTED_TEST_DETAILS_FINAL.lab_rpt_local_id  = trtd.lab_rpt_local_id    and   LAB_TEST_CD  =  'LAB344'   and   LAB_RESULT_TXT_VAL  is not null   and  #tmp_RESULTED_TEST_DETAILS_FINAL.RESULTED_LAB_TEST_KEY =  trtd.RESULTED_LAB_TEST_KEY  ) ;
					update #tmp_RESULTED_TEST_DETAILS_FINAL set   LAB17  = (  select top 1    substring(trtd.TEST_RESULT_VAL_CD_DESC,1,50)   from #tmp_RESULTED_TEST_DETAILS trtd where #tmp_RESULTED_TEST_DETAILS_FINAL.lab_rpt_local_id  = trtd.lab_rpt_local_id    and   LAB_TEST_CD  =  'LAB345'   and    TEST_RESULT_VAL_CD_DESC  is not null  and  #tmp_RESULTED_TEST_DETAILS_FINAL.RESULTED_LAB_TEST_KEY =  trtd.RESULTED_LAB_TEST_KEY ) ;
					update #tmp_RESULTED_TEST_DETAILS_FINAL set   LAB18  = (  select top 1    substring(trtd.TEST_RESULT_VAL_CD_DESC,1,50)   from #tmp_RESULTED_TEST_DETAILS trtd where #tmp_RESULTED_TEST_DETAILS_FINAL.lab_rpt_local_id  = trtd.lab_rpt_local_id    and   LAB_TEST_CD  =  'LAB346'   and    TEST_RESULT_VAL_CD_DESC  is not null  and  #tmp_RESULTED_TEST_DETAILS_FINAL.RESULTED_LAB_TEST_KEY =  trtd.RESULTED_LAB_TEST_KEY ) ;
					update #tmp_RESULTED_TEST_DETAILS_FINAL set   LAB19  = (  select top 1    substring(trtd.TEST_RESULT_VAL_CD_DESC,1,50)   from #tmp_RESULTED_TEST_DETAILS trtd where #tmp_RESULTED_TEST_DETAILS_FINAL.lab_rpt_local_id  = trtd.lab_rpt_local_id    and   LAB_TEST_CD  =  'LAB347'   and    TEST_RESULT_VAL_CD_DESC  is not null  and  #tmp_RESULTED_TEST_DETAILS_FINAL.RESULTED_LAB_TEST_KEY =  trtd.RESULTED_LAB_TEST_KEY ) ;
					update #tmp_RESULTED_TEST_DETAILS_FINAL set   LAB20  = (  select top 1    substring(trtd.LAB_RESULT_TXT_VAL,1,100)  from #tmp_RESULTED_TEST_DETAILS trtd where #tmp_RESULTED_TEST_DETAILS_FINAL.lab_rpt_local_id  = trtd.lab_rpt_local_id    and   LAB_TEST_CD  =  'LAB348'   and   LAB_RESULT_TXT_VAL  is not null   and  #tmp_RESULTED_TEST_DETAILS_FINAL.RESULTED_LAB_TEST_KEY =  trtd.RESULTED_LAB_TEST_KEY  ) ;
					update #tmp_RESULTED_TEST_DETAILS_FINAL set   LAB21  = (  select top 1    trtd.FROM_TIME  from #tmp_RESULTED_TEST_DETAILS trtd where #tmp_RESULTED_TEST_DETAILS_FINAL.lab_rpt_local_id  = trtd.lab_rpt_local_id    and   LAB_TEST_CD  =  'LAB349'  and   FROM_TIME  is not null  and  #tmp_RESULTED_TEST_DETAILS_FINAL.RESULTED_LAB_TEST_KEY =  trtd.RESULTED_LAB_TEST_KEY   ) ;
					update #tmp_RESULTED_TEST_DETAILS_FINAL set   LAB22  = (  select top 1    trtd.FROM_TIME  from #tmp_RESULTED_TEST_DETAILS trtd where #tmp_RESULTED_TEST_DETAILS_FINAL.lab_rpt_local_id  = trtd.lab_rpt_local_id    and   LAB_TEST_CD  =  'LAB350'  and   FROM_TIME  is not null  and  #tmp_RESULTED_TEST_DETAILS_FINAL.RESULTED_LAB_TEST_KEY =  trtd.RESULTED_LAB_TEST_KEY   ) ;
					update #tmp_RESULTED_TEST_DETAILS_FINAL set   LAB23  = (  select top 1    substring(trtd.TEST_RESULT_VAL_CD_DESC,1,50)   from #tmp_RESULTED_TEST_DETAILS trtd where #tmp_RESULTED_TEST_DETAILS_FINAL.lab_rpt_local_id  = trtd.lab_rpt_local_id    and   LAB_TEST_CD  =  'LAB351'   and    TEST_RESULT_VAL_CD_DESC  is not null  and  #tmp_RESULTED_TEST_DETAILS_FINAL.RESULTED_LAB_TEST_KEY =  trtd.RESULTED_LAB_TEST_KEY ) ;
					update #tmp_RESULTED_TEST_DETAILS_FINAL set   LAB24  = (  select top 1    substring(trtd.TEST_RESULT_VAL_CD_DESC,1,50)   from #tmp_RESULTED_TEST_DETAILS trtd where #tmp_RESULTED_TEST_DETAILS_FINAL.lab_rpt_local_id  = trtd.lab_rpt_local_id    and   LAB_TEST_CD  =  'LAB352'   and    TEST_RESULT_VAL_CD_DESC  is not null  and  #tmp_RESULTED_TEST_DETAILS_FINAL.RESULTED_LAB_TEST_KEY =  trtd.RESULTED_LAB_TEST_KEY ) ;
					update #tmp_RESULTED_TEST_DETAILS_FINAL set   LAB25  = (  select top 1    substring(trtd.TEST_RESULT_VAL_CD_DESC,1,50)   from #tmp_RESULTED_TEST_DETAILS trtd where #tmp_RESULTED_TEST_DETAILS_FINAL.lab_rpt_local_id  = trtd.lab_rpt_local_id    and   LAB_TEST_CD  =  'LAB353'   and    TEST_RESULT_VAL_CD_DESC  is not null  and  #tmp_RESULTED_TEST_DETAILS_FINAL.RESULTED_LAB_TEST_KEY =  trtd.RESULTED_LAB_TEST_KEY ) ;
					update #tmp_RESULTED_TEST_DETAILS_FINAL set   LAB26  = (  select top 1    substring(trtd.LAB_RESULT_TXT_VAL,1,100)  from #tmp_RESULTED_TEST_DETAILS trtd where #tmp_RESULTED_TEST_DETAILS_FINAL.lab_rpt_local_id  = trtd.lab_rpt_local_id    and   LAB_TEST_CD  =  'LAB354'   and   LAB_RESULT_TXT_VAL  is not null   and  #tmp_RESULTED_TEST_DETAILS_FINAL.RESULTED_LAB_TEST_KEY =  trtd.RESULTED_LAB_TEST_KEY  ) ;
					update #tmp_RESULTED_TEST_DETAILS_FINAL set   LAB27  = (  select top 1    substring(trtd.TEST_RESULT_VAL_CD_DESC,1,50)   from #tmp_RESULTED_TEST_DETAILS trtd where #tmp_RESULTED_TEST_DETAILS_FINAL.lab_rpt_local_id  = trtd.lab_rpt_local_id    and   LAB_TEST_CD  =  'LAB355'   and    TEST_RESULT_VAL_CD_DESC  is not null  and  #tmp_RESULTED_TEST_DETAILS_FINAL.RESULTED_LAB_TEST_KEY =  trtd.RESULTED_LAB_TEST_KEY ) ;
					update #tmp_RESULTED_TEST_DETAILS_FINAL set   LAB28  = (  select top 1    trtd.FROM_TIME  from #tmp_RESULTED_TEST_DETAILS trtd where #tmp_RESULTED_TEST_DETAILS_FINAL.lab_rpt_local_id  = trtd.lab_rpt_local_id    and   LAB_TEST_CD  =  'LAB356'  and   FROM_TIME  is not null  and  #tmp_RESULTED_TEST_DETAILS_FINAL.RESULTED_LAB_TEST_KEY =  trtd.RESULTED_LAB_TEST_KEY   ) ;
					update #tmp_RESULTED_TEST_DETAILS_FINAL set   LAB29  = (  select top 1    trtd.FROM_TIME  from #tmp_RESULTED_TEST_DETAILS trtd where #tmp_RESULTED_TEST_DETAILS_FINAL.lab_rpt_local_id  = trtd.lab_rpt_local_id    and   LAB_TEST_CD  =  'LAB357'  and   FROM_TIME  is not null  and  #tmp_RESULTED_TEST_DETAILS_FINAL.RESULTED_LAB_TEST_KEY =  trtd.RESULTED_LAB_TEST_KEY   ) ;
					update #tmp_RESULTED_TEST_DETAILS_FINAL set   LAB30  = (  select top 1    substring(trtd.TEST_RESULT_VAL_CD_DESC,1,50)   from #tmp_RESULTED_TEST_DETAILS trtd where #tmp_RESULTED_TEST_DETAILS_FINAL.lab_rpt_local_id  = trtd.lab_rpt_local_id    and   LAB_TEST_CD  =  'LAB358'   and    TEST_RESULT_VAL_CD_DESC  is not null  and  #tmp_RESULTED_TEST_DETAILS_FINAL.RESULTED_LAB_TEST_KEY =  trtd.RESULTED_LAB_TEST_KEY ) ;
					update #tmp_RESULTED_TEST_DETAILS_FINAL set   LAB31  = (  select top 1    substring(trtd.TEST_RESULT_VAL_CD_DESC,1,50)   from #tmp_RESULTED_TEST_DETAILS trtd where #tmp_RESULTED_TEST_DETAILS_FINAL.lab_rpt_local_id  = trtd.lab_rpt_local_id    and   LAB_TEST_CD  =  'LAB359'   and    TEST_RESULT_VAL_CD_DESC  is not null  and  #tmp_RESULTED_TEST_DETAILS_FINAL.RESULTED_LAB_TEST_KEY =  trtd.RESULTED_LAB_TEST_KEY ) ;
					update #tmp_RESULTED_TEST_DETAILS_FINAL set   LAB32  = (  select top 1    trtd.LAB_RESULT_TXT_VAL  from #tmp_RESULTED_TEST_DETAILS trtd where #tmp_RESULTED_TEST_DETAILS_FINAL.lab_rpt_local_id  = trtd.lab_rpt_local_id    and   LAB_TEST_CD  =  'LAB360'   and   LAB_RESULT_TXT_VAL  is not null   and  #tmp_RESULTED_TEST_DETAILS_FINAL.RESULTED_LAB_TEST_KEY =  trtd.RESULTED_LAB_TEST_KEY  ) ;
					update #tmp_RESULTED_TEST_DETAILS_FINAL set   LAB33  = (  select top 1    trtd.FROM_TIME  from #tmp_RESULTED_TEST_DETAILS trtd where #tmp_RESULTED_TEST_DETAILS_FINAL.lab_rpt_local_id  = trtd.lab_rpt_local_id    and   LAB_TEST_CD  =  'LAB361'  and   FROM_TIME  is not null  and  #tmp_RESULTED_TEST_DETAILS_FINAL.RESULTED_LAB_TEST_KEY =  trtd.RESULTED_LAB_TEST_KEY   ) ;
					update #tmp_RESULTED_TEST_DETAILS_FINAL set   LAB34  = (  select top 1    trtd.FROM_TIME  from #tmp_RESULTED_TEST_DETAILS trtd where #tmp_RESULTED_TEST_DETAILS_FINAL.lab_rpt_local_id  = trtd.lab_rpt_local_id    and   LAB_TEST_CD  =  'LAB362'  and   FROM_TIME  is not null  and  #tmp_RESULTED_TEST_DETAILS_FINAL.RESULTED_LAB_TEST_KEY =  trtd.RESULTED_LAB_TEST_KEY   ) ;
					update #tmp_RESULTED_TEST_DETAILS_FINAL set   LAB35  = (  select top 1    substring(trtd.TEST_RESULT_VAL_CD_DESC,1,50)   from #tmp_RESULTED_TEST_DETAILS trtd where #tmp_RESULTED_TEST_DETAILS_FINAL.lab_rpt_local_id  = trtd.lab_rpt_local_id    and   LAB_TEST_CD  =  'LAB363'   and    TEST_RESULT_VAL_CD_DESC  is not null  and  #tmp_RESULTED_TEST_DETAILS_FINAL.RESULTED_LAB_TEST_KEY =  trtd.RESULTED_LAB_TEST_KEY ) ;
					...
					CREATE TABLE ISOLATE_TRACKING_WITH_LAB330 AS
						SELECT TRACK_INFO.*,
							   LAB330.LAB330
						FROM #tmp_RESULTED_TEST_DETAILS AS TRACK_INFO
 ...
 ;
			...
			COMMIT TRANSACTION;
			 ...
			 --drop table   #tmp_lab_test_resultInit ;
				...
				IF OBJECT_ID('#tmp_ISOLATE_TRACKING_LAB330_INIT', 'U') IS NOT NULL  drop table    	#tmp_ISOLATE_TRACKING_LAB330_INIT	;
				IF OBJECT_ID('#tmp_RESULTED_TEST_DETAILS_FINAL', 'U') IS NOT NULL  drop table    	#tmp_RESULTED_TEST_DETAILS_FINAL	;
				IF OBJECT_ID('#tmp_ISOLATE_TRACKING_WITH_LAB330', 'U') IS NOT NULL  drop table    	#tmp_ISOLATE_TRACKING_WITH_LAB330	;
